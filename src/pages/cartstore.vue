<template>
  <div class="macbook-pro-16-2">
    ...
    <div class="card-2-column">
      <div class="blocks" v-for="item in data.getCartItems" :key="item.id">
        <div class="block">
          <div class="href">
            <img :src="item.link" class="fluid rounded" width="200" height="250" :alt="item.name" />
          </div>
        </div>
        <div class="text">
    ...
    <img class="macbook-pro-16-2-inner" alt="" src="/rectangle-10.svg" />
    <img class="icon-close-circle1" alt="" src="/-icon-close-circle1.svg" />
    <div class="col-md-6" v-for="(product, index) in data.products" :key="product.id" :product="product">
      <div class="column-for-content-elements">
        <img class="demo-image-movieposter3" alt="" src="/demo-image-movieposter1@2x.png" />
        <div class="text15">2019</div>
        <b class="text16">rp</b>
        <div class="text17">
          <p class="p">
          ...
          <p class="p">
            <span>Director :Todd Phillitttttpstt</span>
          </p>
          <p class="p">
            <span>&nbsp;</span>
          </p>
        ...
        <div class="button5">
          <b class="order-now">Add to cart</b>
        </div>
      </div>
    </div>
    <div class="column-for-content-elements1">
      <img class="demo-image-movieposter3" alt="" src="/demo-image-movieposter1@2x.png" />
      <div class="text15">2019</div>
      <b class="text16">JOKER</b>
      <div class="text17">
        <p class="p">
          <span class="span">8.4</span>
        </p>
    ...
    <div class="column-for-content-elements2" v-for="(product, index) in data.products" :key="product.id"
      :product="product">
      <img class="demo-image-movieposter3" alt="" :src="product.link" />
      <div class="text15">2019</div>
      <b class="text16">JOKER</b>
      <div class="text17">
        <p class="p">
...
.button1 {
  ...
  padding: var(--padding-4xl) 0px var(--padding-4xl) var(--padding-12xs);
  box-sizing: border-box;
  gap: var(--gap-7xs);
}
...
.button2 {
  ...
  box-shadow: 0px 1px 2px rgba(20, 14, 62, 0.25),
    0px 0px 0px 1px #4834d4 inset,
    0px 1px 1px 1px rgba(255, 255, 255, 0.25) inset,
    0px -1px 1px 1px rgba(52, 35, 170, 0.25) inset;
  ...
  align-items: center;
  justify-content: flex-start;
  padding: var(--padding-lgi) var(--padding-base) var(--padding-sm) var(--padding-lgi);
  gap: var(--gap-lgi);
  opacity: 0.8;
}
...
.card-2-column {
  ...
  align-items: center;
  justify-content: flex-start;
  padding: var(--padding-12xl) var(--padding-3xs) var(--padding-xl);
  box-sizing: border-box;
...
.card-2-column1 {
  ...
  align-items: center;
  justify-content: flex-start;
  padding: 15px var(--padding-3xs) var(--padding-xl);
  box-sizing: border-box;
